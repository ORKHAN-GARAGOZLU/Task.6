namespace Task._6
{
    internal class Program
    {
        ...
        l2:
            ...
            Console.WriteLine($"Hendesi orta : {Math.Round(hendesiOrta)}");
        ...
        l1:
            ...
            Console.WriteLine($"Hendesiorta: {Math.Round(hendesiOrta)}");
        ...
        /* X(20) massivinin ilk yarisinin ededi ortasini ikinci yarisinin hendesi ortasini tapmaq */
            ...
            Console.WriteLine($"Ikinci yarinin hendesi ortasi: {Math.Round(hendesiOrta)}");
